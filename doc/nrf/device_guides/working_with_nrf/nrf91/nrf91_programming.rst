...
To program firmware onto nRF91 Series devices, follow the process described in the :ref:`programming` section, but pay attention to the exceptions specific to the nRF91 Series that are listed below.
