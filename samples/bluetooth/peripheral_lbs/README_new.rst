...
.. list-table:: Configuration files
   ...
   * - :file:`prj_minimal.conf`
     - Configuration file for minimal build with reduced code size and RAM usage.
...
Building and running minimal configuration
******************************************

The sample can be built with a minimum configuration to demonstrate reduced code size and RAM usage.
The minimal configuration uses the :file:`prj_minimal.conf` file, which disables features not needed for basic functionality and optimizes memory usage.

Configuring minimal configuration
=================================

The minimal configuration disables several features:

* Console and logging functionalities
* Memory protection features
* Various Bluetooth features not essential for basic operation
* Reduced Bluetooth buffer sizes
* Various system features like watchdog, I2C, and SPI

Building minimal configuration
==============================

To build with minimal configuration, use the ``-DFILE_SUFFIX=minimal`` flag in your build.
...
The testing steps are the same as for the basic configuration.
