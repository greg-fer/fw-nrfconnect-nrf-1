...
.. list-table:: Configuration files
   ...
   * - File name
     - Description
   * - :file:`prj.conf`
     - Basic configuration file for the main Memfault application.
   * - :file:`ipc_radio/prj.conf`
     - Configuration file for the network core that provides the :ref:`IPC Radio companion component <companion_components>`.
       This file is automatically applied when using :ref:`configuration_system_overview_sysbuild` and an SoC with a network core.
